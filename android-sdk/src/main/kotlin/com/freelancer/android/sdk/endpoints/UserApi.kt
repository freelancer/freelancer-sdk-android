...
interface UserApi {
    ...
    @GET("users/{user_id}")
    fun getUserById(@Path("user_id") userId: Long): Single<FLUser>
    ...
    fun searchForFreelancers(@Query("jobs[]") jobIds: List<Long>? = null,
                             ...
                             @Query("compact") compact: Boolean = true): Single<DirectoryResponse>
    ...
    fun getSelfUser(@Query("avatar") avatar: Boolean = true,
                    ...
                    @Query("limit") limit: Int,
                    @Query("offset") offset: Int,
                    @Query("compact") compact: Boolean = true): Single<FLUser>

    @FormUrlEncoded
    @POST("self/jobs")
    fun addToUser(@Field("jobs[]") jobs: List<Long>): Single<ApiResponse>

    @FormUrlEncoded
    @PUT("self/jobs")
    fun setForUser(@Field("jobs[]") jobs: List<Long>): Single<ApiResponse>

    @FormUrlEncoded
    @DELETE("self/jobs")
    fun deleteFromUser(@Field("jobs[]") jobs: List<Long>): Single<ApiResponse>
    ...
    fun listUserReputation(@Query("users[]") userIds: List<Long>,
                           ...
                           @Query("rehire_rates") rehireRates: Boolean = true): Single<Reputation>
...
//            @Query("limit") limit: Int,
//            @Query("offset") offset: Int): Single<ApiResponse>
}