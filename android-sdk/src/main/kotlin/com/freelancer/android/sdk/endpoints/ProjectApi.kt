...
interface ProjectApi {
    @POST("projects")
    fun createProject(@Body project: PostProjectRequest): Single<Project>

    @PUT("projects/{project_id}/")
    fun projectActions(@Path("project_id") projectId: Long,
                       @Body action: PutProjectActionRequest): Single<ApiResponse>
...
//            @Query("user_past_cover_images") userPastCoverImages: Boolean = true,
                     ...
                     @Query("offset") offset: Int): Single<ProjectListResponse>
...
//            @Query("user_past_cover_images") userPastCoverImages: Boolean = true,
                       ...
                       @Query("corporate_users") corporateUsers: Boolean = true,
                       @Query("limit") limit: Int,
                       @Query("offset") offset: Int): Single<Project>
...
//            @Query("user_past_cover_images") userPastCoverImages: Boolean = false,
    ...
    fun listProjectBids(@Path("project_id") projectId: Long,
                        ...
                        @Query("user_reputation") user_reputation: Boolean = true
    ): Single<BidsResponse>

    @GET("projects/{project_id}/bidinfo/")
    fun getProjectBidInformation(@Path("project_id") projectId: Long): Single<BidInfo>
    ...
    fun addAttachment(
            ...
            @Part attachment: MultipartBody.Part): Single<AddAttachmentResponse>
}